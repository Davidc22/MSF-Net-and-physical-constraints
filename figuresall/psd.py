...
TABLE3_RMSE = {
    ...
    "CNN":         [57.63, 148.31,  75.80,  76.70],
    "Transformer": [34.83,  88.19,  67.75,  71.35],
    "SA":          [37.38,  86.32,  67.91,  65.70],
    "ES-MHSA":    [34.83,  82.07,  65.49,  63.24],
...
# Fig 5: PSD Error Analysis (Xisha)
# ============================================================
def compute_radial_psd(grid, dx=1852.0):
    g = grid.copy()
    g[np.isnan(g)] = 0
    ny, nx = g.shape
    F = np.fft.fft2(g)
...
def plot_fig5(arrays_data, outdir):
    ...
    ax.set_xlim(5, 400)
    ax.invert_xaxis()  # 确保长波长在左边，短波长在右边
